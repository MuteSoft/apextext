...
public class HelpTopic extends DefaultMutableTreeNode {
    ...
    public URL getTargetPageURL() {
        return getURL("help/" + getTargetPage());
    }
    ...
    private URL getURL(String page) {
        URL url = HelpTopic.class.getClassLoader().getResource(page);
        return url;
    }
    ...
    public static URL getBlankPageURL() {
        URL url = HelpTopic.class.getClassLoader().getResource("help/Blank.html");
        return url;
    }
