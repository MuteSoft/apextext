/*
 * FindTextEventHandler.java
 * Created on May 31, 2007, 8:50 PM
 *
...
/**
 * An event handler to find a text in editor.
 * @author Mrityunjoy Saha
 * @version 1.0
 * @since Apex 1.0
 */
public class FindTextEventHandler extends UIEventHandler {

    /**
     * Creates a new instance of {@code FindTextEventHandler}.
     */
    public FindTextEventHandler() {
    }
