/*
 * FindNextMenu.java
 * Created on May 16, 2007, 2:24 PM
 *
 ...
 * @since Apex 1.0
 */
public class FindNextMenu extends UILessMenu {
    ...
    /**
     * Creates a new instance of FindNextMenu.
     */
    public FindNextMenu() {
    ...
    protected void execute(InputParams in, OutputParams out) {
        SearchTextUtility.getModel().setBackwardSearch(false);
