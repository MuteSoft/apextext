...
import org.apex.base.validator.CDocumentValidator;
import org.apex.base.validator.AbstractValidator;

/**
 * A C document which can be viewed and edited in the application.
...
public class CDocument extends AbstractDocument {
    ...
    /**
     * Constructs a new C document with given name.
     * @param name The document name.
     * @param docType The document type.
     */
    public CDocument(String name, IDocumentType docType) {
        super(name, docType);
    }

    /**
     * Constructs a C document with given path and name.
     * @param path The path of document in file system.
     * @param name The name of document.
     * @param docType The document type.
     */
    public CDocument(String path, String name, IDocumentType docType) {
        super(path, name, docType);
    }

    @Override
    public AbstractDocument clone(String absolutePath) {
        return super.copyPropertiesTo(new CDocument(absolutePath, getDocumentType()));
    }

    @Override
    public AbstractValidator getValidator() {
        if (validator == null) {
            validator = new CDocumentValidator();
        }
        return validator;
    }
