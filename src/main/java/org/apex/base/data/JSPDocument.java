...
import org.apex.base.validator.JSPDocumentValidator;

/**
 * A JSP document which can be viewed and edited in the application.
 * @author Mrityunjoy Saha
 * @version 1.1
 * @since Apex 1.0
 */
public class JSPDocument extends AbstractDocument {
    ...
    /**
     * Constructs a new JSP document with given name.
     * @param name The document name.
     * @param docType The document type.
     */
    public JSPDocument(String name, IDocumentType docType) {
        super(name, docType);
    }

    /**
     * Constructs a JSP document with given path and name.
     * @param path The path of document in file system.
     * @param name The name of document.
     * @param docType The document type.
     */
    public JSPDocument(String path, String name, IDocumentType docType) {
    ...
    public AbstractValidator getValidator() {
        if (validator == null) {
            validator = new JSPDocumentValidator();
        }
        return validator;
    }
    ...
    public Object getLexer() {
        return DocumentLexers.JSP_LEXER;
    }
