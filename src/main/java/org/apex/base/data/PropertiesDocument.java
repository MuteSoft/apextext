...
import org.apex.base.validator.PropertiesDocumentValidator;

/**
 * A Properties document which can be viewed and edited in the application.
...
public class PropertiesDocument extends AbstractDocument {
    ...
    /**
     * Constructs a new Properties document with given name.
     * @param name The document name.
     * @param docType The document type.
     */
    public PropertiesDocument(String name, IDocumentType docType) {
        super(name, docType);
    }

    /**
     * Constructs a Properties document with given path and name.
     * @param path The path of document in file system.
     * @param name The name of document.
     * @param docType The document type.
     */
    public PropertiesDocument(String path, String name, IDocumentType docType) {
    ...
    public AbstractDocument clone(String absolutePath) {
        return super.copyPropertiesTo(new PropertiesDocument(absolutePath, getDocumentType()));
    }

    @Override
    public AbstractValidator getValidator() {
        if (validator == null) {
            validator = new PropertiesDocumentValidator();
        }
        return validator;
    }
    ...
    public Object getLexer() {
        return DocumentLexers.PROPERTIES_LEXER;
    }
