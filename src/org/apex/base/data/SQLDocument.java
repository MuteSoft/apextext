...
import org.apex.base.validator.SQLDocumentValidator;

/**
 * A SQL document which can be viewed and edited in the application.
 * @author Mrityunjoy Saha
 * @version 1.1
 * @since Apex 1.0
 */
public class SQLDocument extends AbstractDocument {
    ...
    /**
     * Constructs a new SQL document with given name.
     * @param name The document name.
     * @param docType The document type.
     */
    public SQLDocument(String name, IDocumentType docType) {
        super(name, docType);
    }

    /**
     * Constructs a SQL document with given path and name.
     * @param path The path of document in file system.
     * @param name The name of document.
     * @param docType The document type.
     */
    public SQLDocument(String path, String name, IDocumentType docType) {
    ...
    public AbstractDocument clone(String absolutePath) {
        return super.copyPropertiesTo(new SQLDocument(absolutePath, getDocumentType()));
    }

    @Override
    public AbstractValidator getValidator() {
        if (validator == null) {
            validator = new SQLDocumentValidator();
        }
        return validator;
    }
    ...
    public Object getLexer() {
        return DocumentLexers.SQL_LEXER;
    }
