...
import org.apex.base.validator.XMLDocumentValidator;

/**
 * An XML document which can be viewed and edited in the application.
...
public class XMLDocument extends AbstractDocument {
    ...
    /**
     * Constructs a new XML document with given name.
     * @param name The document name.
     * @param docType The document type.
     */
    public XMLDocument(String name, IDocumentType docType) {
        super(name, docType);
    }

    /**
     * Constructs an XML document with given path and name.
     * @param path The path of document in file system.
     * @param name The name of document.
     * @param docType The document type.
     */
    public XMLDocument(String path, String name, IDocumentType docType) {
    ...
    public AbstractDocument clone(String absolutePath) {
        return super.copyPropertiesTo(new XMLDocument(absolutePath, getDocumentType()));
    }
    ...
    public Object getLexer() {
        return DocumentLexers.XML_LEXER;
    }
