...
public class EditorKeyConstants {
     ...
     */
    public static final String TAB_CLOSE_BUTTON = "resources/closeButton_14.gif";
    /**
     ...
     * Path of editor icon.
     */
    public static final String EDITOR_ICON = "resources/apex.png";
    /**
     ...
     */
    public static final String APPLICATION_SHORT_LOGO = "resources/apexlogo-short.png";
    /**
     ...
     */
    public static final String DEFAULT_FILE_ICON = "resources/file-2.gif";
    /**
     ...
     */
    public static final String OUTPUT_WINDOW_TAB_ICON = "resources/console-2.png";
    /**
     ...
     */
    public static final String CONSOLE_START_ICON = "start-1.gif";
      /**
     * Stop icon to be displayed in console.
     */
    public static final String CONSOLE_STOP_ICON = "stop-3.gif";
      /**
     * Clear icon to be displayed in console.
     */
    public static final String CONSOLE_CLEAR_ICON = "clear-4.gif";
